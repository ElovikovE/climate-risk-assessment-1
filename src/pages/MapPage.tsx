...
export default function MapPage({ initialFilter = 'objects' }: MapPageProps) {
  ...
  useEffect(() => {
    ...
    // Граница Республики Адыгея (уточнённый контур)
    const adygeaBounds: L.LatLngTuple[] = [
      [44.95, 38.98], [45.03, 39.18], [45.08, 39.42], [45.05, 39.68],
      [44.96, 39.88], [44.87, 40.05], [44.75, 40.28], [44.63, 40.52],
      [44.47, 40.58], [44.30, 40.48], [44.18, 40.28], [44.05, 40.08],
      [43.90, 39.85], [43.82, 39.55], [43.85, 39.25], [44.00, 39.02],
      [44.20, 38.90], [44.50, 38.88], [44.72, 38.93], [44.95, 38.98],
    ];
